...
function LotCard({
  ...
  const card = (
    <div
      className="bg-[var(--paper)] flex flex-col relative"
      style={{
        border: '1px solid var(--ink)',
        borderRadius: 0,
        // On mobile each card is 85vw wide so the next peeks; desktop untouched
        ...(isMobile ? { width: '85vw', flexShrink: 0, scrollSnapAlign: 'start' } : {}),
        padding: '1.5rem',
      }}
    >
      {origin.stamp && (
      ...
      <div className="font-['IBM_Plex_Mono'] text-[var(--ink)] uppercase tracking-[0.1em] font-semibold text-base mb-4 pr-10">
        {origin.lot} — {origin.name.toUpperCase()}
      </div>

      <div className="w-full mb-4" style={{ height: '1px', background: 'var(--jute)' }} />
      ...
      <div className="w-full mb-4" style={{ height: '1px', background: 'var(--jute)', opacity: 0.5 }} />

      <p className="font-['Archivo'] text-[var(--ink)] text-sm leading-[1.65] mb-5 flex-1 line-clamp-2">
        {origin.desc}
      </p>
...
export function OriginCoffees() {
  ...
  return (
    <section id="origins" className="py-20 md:py-32 bg-[var(--ink)] border-t border-dashed border-[var(--jute)]">
          ...
          <div className="flex flex-col gap-4">
            <div
              ...
              style={{
                ...
                paddingRight: 'calc(15vw + 1.25rem)', // let last card partially peek
              }}
            >
            ...
            <div className="flex items-center justify-center gap-3 px-5 pb-2">
              <span className="font-['IBM_Plex_Mono'] text-[var(--jute)] text-sm uppercase tracking-[0.1em]">
                LOT {String(activeIndex + 1).padStart(2, '0')} / {String(origins.length).padStart(2, '0')}
              </span>
                ...
                {origins.map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: '4px',
                      background: i === activeIndex ? 'var(--jute)' : 'var(--jute)',
